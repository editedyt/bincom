...
require_once '../connection.php';
    ...
    $drop_tbl = "DROP TABLE IF EXISTS `polling_unit`";
    $create_tbl = "CREATE TABLE IF NOT EXISTS `polling_unit` (
    ...
    $insert_to_tbl = "INSERT INTO `polling_unit` (`uniqueid`, `polling_unit_id`, `ward_id`, `lga_id`, `uniquewardid`, `polling_unit_number`, `polling_unit_name`, `polling_unit_description`, `lat`, `long`, `entered_by_user`, `date_entered`, `user_ip_address`) VALUES
