...
require_once '../connection.php';
    ...
    $drop_tbl = "DROP TABLE IF EXISTS `lga`";
    $create_tbl = "CREATE TABLE IF NOT EXISTS `lga` (
    ...
    $insert_to_tbl = "INSERT INTO `lga` (`uniqueid`, `lga_id`, `lga_name`, `state_id`, `lga_description`, `entered_by_user`, `date_entered`, `user_ip_address`) VALUES
