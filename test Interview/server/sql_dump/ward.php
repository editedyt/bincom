...
require_once '../connection.php';
    ...
    $drop_tbl = "DROP TABLE IF EXISTS `ward`";
    $create_tbl = "CREATE TABLE IF NOT EXISTS `ward` (
    ...
    $insert_to_tbl = "INSERT INTO `ward` (`uniqueid`, `ward_id`, `ward_name`, `lga_id`, `ward_description`, `entered_by_user`, `date_entered`, `user_ip_address`) VALUES
